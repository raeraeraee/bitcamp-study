  ...
  private void loadMember() {
    try {
      ...
      for (int i = 0; i < size; i++) {
        ...
        member.setGit_push((char) (in.read() << 8 | in.read()));

        member.setProgrammers((char) (in.read() << 8 | in.read()));
  ...
  private void saveMember() {
    try {
      ...
      for (Member member : memberList) {
        ...
        char git_push = member.getGit_push();
        out.write(git_push >> 8);
        out.write(git_push);
        
        char programmers = member.getProgrammers();
        out.write(programmers >> 8);
        out.write(programmers);
      }
      out.close();
