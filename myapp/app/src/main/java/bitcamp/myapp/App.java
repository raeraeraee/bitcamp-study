...
public class App2 {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in); // new java.util.Scanner(System.in);
    ...
    static boolean promtContinue(Scanner scanner) {
        System.out.print("계속 하시겠습니까?(Y/n) ");
        String response = scanner.nextLine();
        if (!response.equals("") && !response.equalsIgnoreCase("Y")) { // 응답(response)이 빈문자도 아니고 Y도 아닐때 break //
            return false;
        }
        return true;
    }
